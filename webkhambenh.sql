...
('Sinh viên Nguyễn Văn C', 'nguyenvanc@example.com', '0945678901', 'Sinh viên tòa A8', 'Ngoại tổng hợp', 'Bác sĩ điều trị', 'Sinh viên thực tập', 1, '/placeholder.svg', 'Sinh viên thực tập'),
('Sinh viên Nguyễn Văn D', 'nguyenvanD@example.com', '0945678901', 'Sinh viên tòa A8', 'Ngoại tổng hợp', 'Bác sĩ điều trị', 'Sinh viên thực tập', 2, '/placeholder.svg', 'Sinh viên thực tập'),
...
('Sinh viên Nguyễn Hữu Tài', 'nguyenhuutai@example.com', '0922333444', 'Sinh viên tòa A8', 'Khoa Dược', 'Bác sĩ phụ trách tư vấn thuốc', 'Sinh viên thực tập', 1, '/placeholder.svg', 'Sinh viên thực tập'),
...
('Sinh viên Nguyễn Thị Thu', 'nguyenthithu@example.com', '0944555666', 'Sinh viên tòa A8', 'Nội tổng hợp', 'Sinh viên thực tập tại khoa Nội', 'Sinh viên thực tập', 2, '/placeholder.svg', 'Sinh viên thực tập'),
...
('Sinh viên Phạm Văn Toàn', 'phamvantoan@example.com', '0911000222', 'Sinh viên tòa A8', 'Tim mạch', 'Bác sĩ nội trú chuyên khoa tim', 'Sinh viên thực tập', 1, '/placeholder.svg', 'Sinh viên thực tập'),
...
('Sinh viên Nguyễn Văn Hưng', 'nguyenvanhung@example.com', '0955667788', 'Sinh viên tòa A8', 'Khoa Dược', 'Dược sĩ tư vấn', 'Sinh viên thực tập', 2, '/placeholder.svg', 'Sinh viên thực tập'),
('Sinh viên Trần Văn Nam', 'tranvannam@example.com', '0911223345', 'Bệnh viện Đại học Phenikaa', 'Nội tổng hợp', 'Sinh viên thực tập tại khoa Nội', 'Sinh viên thực tập', 1, '/placeholder.svg', 'Sinh viên thực tập'),
('Sinh viên Lê Thị Hoa', 'lethihoa@example.com', '0922334456', 'Bệnh viện Đại học Phenikaa', 'Ngoại tổng hợp', 'Sinh viên thực tập tại khoa Ngoại', 'Sinh viên thực tập', 2, '/placeholder.svg', 'Sinh viên thực tập'),
('Sinh viên Phạm Quốc Việt', 'phamquocviet@example.com', '0933445567', 'Phòng khám Đa khoa Đại học Phenikaa', 'Tim mạch', 'Sinh viên thực tập tại khoa Tim mạch', 'Sinh viên thực tập', 1, '/placeholder.svg', 'Sinh viên thực tập'),
('Sinh viên Nguyễn Thị Lan', 'nguyenthilan@example.com', '0944556678', 'Phòng khám Đa khoa Đại học Phenikaa', 'Khoa sản', 'Sinh viên thực tập tại khoa Sản', 'Sinh viên thực tập', 2, '/placeholder.svg', 'Sinh viên thực tập');