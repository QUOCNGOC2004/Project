...
import './DatLich.css';
import Form1 from '../../components/forDatLich/form1';
import Form2 from '../../components/forDatLich/form2';
...
const DatLich: React.FC = () => {
  ...
  const [duLieuForm, setDuLieuForm] = useState<DuLieuForm>({
    ...
    ngayHen: searchParams.get('ngayHen') || "",
    gioHen: searchParams.get('gioHen') || "",
    hoTen: "",
    email: "",
    gioiTinh: "",
    ngaySinh: "",
